...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        # festival_gallery and important_day_gallery already exist in production.
        # Use SeparateDatabaseAndState to update Django's schema state only,
        # without executing any CREATE TABLE SQL.
        migrations.SeparateDatabaseAndState(
            ...
            database_operations=[
                # Empty — tables already exist in production, no SQL needed
            ],
        ),
    ]
